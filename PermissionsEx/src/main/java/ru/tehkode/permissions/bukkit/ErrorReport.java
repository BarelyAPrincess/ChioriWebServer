...
public class ErrorReport
{
	...
	{
		StringBuilder build = new StringBuilder( "Error occurred with PermissionsEx! Please post it to " ).append( getShortURL() ).append( ". Full error:\n" );
	...
	public static ErrorReport withException( String cause, Throwable error )
	{
		...
		builder.addHeading( "Basic info" ).addText( "**Loader version:** " + Versioning.getVersion() );
