...
public abstract class Command
{
	...
	/**
	 * Sets the label of this command If the command is currently registered the label change will only take effect after
	...
	/**
	 * Sets the list of aliases to request on registration for this command. This is not effective outside of defining
	 * aliases in the {@link PluginDescriptionFile#getCommands()} (under the `<code>aliases</code>' node) is equivalent
	 * to this method.
	 * 
	 * @param aliases
