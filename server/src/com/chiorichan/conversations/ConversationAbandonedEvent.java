...
public class ConversationAbandonedEvent extends EventObject
{
	 ...
	 * 
	 * @return True if the conversation is abandoned gracefully by a {@link Prompt} returning null or the next prompt.
	 *         False of the conversations is abandoned prematurely by a ConversationCanceller.
	 */
