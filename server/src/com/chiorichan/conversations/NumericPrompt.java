...
public abstract class NumericPrompt extends ValidatingPrompt
{
	...
	/**
	 * Override this method to do further validation on the numeric player input after the input has been determined to
	 * actually be a number.
	 * 
	 * @param context
	 *           Context information about the conversation.
	 * @param input
	 *           The number the player provided.
	 ...
	 *           Context information about the conversation.
	 * @param input
	 *           The user's response as a {@link Number}.
