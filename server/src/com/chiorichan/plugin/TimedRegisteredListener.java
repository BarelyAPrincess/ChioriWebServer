...
public class TimedRegisteredListener extends RegisteredListener
{
	 ...
	 * superclass will be returned, such that for any event this listener has handled,
	 * <code>this.getEventClass().isAssignableFrom(event.getClass())</code> and no class
	 ...
	 * <code>eventA.getClass() != eventB.getClass()</code>.
	 * 
