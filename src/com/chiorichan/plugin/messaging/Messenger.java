...
public interface Messenger
{
	...
	/**
	 * Registers the specific plugin to the requested outgoing plugin channel, allowing it to send messages through that
	 * channel to any clients.
	 * 
	 * @param plugin
	...
	/**
	 * Unregisters the specific plugin from the requested outgoing plugin channel, no longer allowing it to send messages
	 * through that channel to any clients.
	 * 
	 * @param plugin
	...
	/**
	 * Unregisters the specific plugin from all outgoing plugin channels, no longer allowing it to send any plugin
	 * messages.
	 * 
	 * @param plugin
	...
	/**
	 * Registers the specific plugin for listening on the requested incoming plugin channel, allowing it to act upon any
	 * plugin messages.
	 * 
	 * @param plugin
	...
	/**
	 * Unregisters the specific plugin's listener from listening on the requested incoming plugin channel, no longer
	...
	/**
	 * Unregisters the specific plugin from listening on the requested incoming plugin channel, no longer allowing it to
	 * act upon any plugin messages.
	 * 
	 * @param plugin
	 *           Plugin that wishes to unregister from this channel.
	 * @param channel
	...
	/**
	 * Gets a set containing all the incoming plugin channel registrations that the specified plugin has on the requested
	 * channel.
	 * 
	 * @param plugin
	 *           Plugin to retrieve registrations for.
