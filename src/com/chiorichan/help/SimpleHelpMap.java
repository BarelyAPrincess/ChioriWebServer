...
import com.chiorichan.command.PluginIdentifiableCommand;
...
public class SimpleHelpMap implements HelpMap
{
		...
		for ( Command command : commands )
		{
			...
			if ( pluginName != null )
			{
				...
				if ( topic != null )
				{
					...
					{
						pluginIndexes.put( pluginName, new TreeSet<HelpTopic>( HelpTopicComparator.helpTopicComparatorInstance() ) ); // keep
																																											// things
																																											// in
																																											// topic
																																											// order
	...
	{
		if ( command instanceof ChioriCommand || command instanceof VanillaCommand )
		{
			return "Bukkit";
		}
	...
	{
		if ( ( command instanceof ChioriCommand || command instanceof VanillaCommand ) && ignoredPlugins.contains( "Bukkit" ) )
		{
			return true;
		}
