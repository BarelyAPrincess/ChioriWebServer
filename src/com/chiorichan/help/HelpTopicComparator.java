...
/**
 * Used to impose a custom total ordering on help topics. All topics are listed in alphabetic order, but topics that
 * start with a slash come after topics that don't.
 */
