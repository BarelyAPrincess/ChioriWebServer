...
public class ConversationContext
{
	...
	/**
	 * Gets session data shared between all {@link Prompt} invocations. Use this as a way to pass data through each
	 * Prompt as the conversation develops.
	 * 
	 * @param key
	...
	/**
	 * Sets session data shared between all {@link Prompt} invocations. Use this as a way to pass data through each
	 * prompt as the conversation develops.
	 * 
	 * @param key
	 *           The session data key.
