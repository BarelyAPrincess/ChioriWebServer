...
public final class PluginCommand extends Command implements PluginIdentifiableCommand
{
	...
	/**
	 * Sets the {@link TabCompleter} to run when tab-completing this command. If no TabCompleter is specified, and the
	 * command's executor implements TabCompleter, then the executor will be used for tab completion.
	 * 
	 * @param completer
	 *           New tab completer
	 */
	 ...
	 * {@link TabCompleter}. If a non-null list has not been found, will default to standard player name completion in
