...
public interface IChioriScheduler
{
	 ...
	 */
	public int scheduleSyncDelayedTask( TaskCreator creator, Runnable task, long delay );
	 ...
	 * @return Task id number (-1 if scheduling failed)
	 */
	public int scheduleSyncDelayedTask( TaskCreator creator, Runnable task );
	 ...
	 * @return Task id number (-1 if scheduling failed)
	 */
	public int scheduleSyncRepeatingTask( TaskCreator creator, Runnable task, long delay, long period );
	 ...
	 */
	@Deprecated
	public int scheduleAsyncDelayedTask( TaskCreator creator, Runnable task, long delay );
	 ...
	 */
	@Deprecated
	public int scheduleAsyncDelayedTask( TaskCreator creator, Runnable task );
	 ...
	 */
	@Deprecated
	public int scheduleAsyncRepeatingTask( TaskCreator creator, Runnable task, long delay, long period );
	 ...
	 */
	public <T> Future<T> callSyncMethod( TaskCreator creator, Callable<T> task );
	 ...
	 */
	public void cancelTasks( TaskCreator creator );
	 ...
	 *              if task is null
	 */
	public IChioriTask runTask( TaskCreator creator, Runnable task ) throws IllegalArgumentException;
	 ...
	 *              if task is null
	 */
	public IChioriTask runTaskAsynchronously( TaskCreator creator, Runnable task ) throws IllegalArgumentException;
	 ...
	 *              if task is null
	 */
	public IChioriTask runTaskLater( TaskCreator creator, Runnable task, long delay ) throws IllegalArgumentException;
	 ...
	 *              if task is null
	 */
	public IChioriTask runTaskLaterAsynchronously( TaskCreator creator, Runnable task, long delay ) throws IllegalArgumentException;
	 ...
	 *              if task is null
	 */
	public IChioriTask runTaskTimer( TaskCreator creator, Runnable task, long delay, long period ) throws IllegalArgumentException;
	 ...
	 *              if task is null
	 */
	public IChioriTask runTaskTimerAsynchronously( TaskCreator creator, Runnable task, long delay, long period ) throws IllegalArgumentException;
}
