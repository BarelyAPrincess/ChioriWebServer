...
/**
 * ValidatingPrompt is the base class for any prompt that requires validation. ValidatingPrompt will keep replaying the
 * prompt text until the user enters a valid response.
 */
