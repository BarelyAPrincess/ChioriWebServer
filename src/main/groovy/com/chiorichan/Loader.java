...
public class Loader extends BuiltinRegistrar implements Listener
{
	...
	/**
	 * Gets an instance of the system logger so requester can log information to both the screen and log file with ease. The auto selection of named loggers might be temporary feature until most of system can be manually programmed to use named loggers
