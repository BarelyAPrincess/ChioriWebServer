...
public class GroupCommands extends PermissionsCommand
{
	...
	public void groupsList( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
	...
	public void groupsListAlias( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
	...
	public void groupsListAnotherAlias( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		this.groupsList( plugin, sender, args );
	}
	...
	public void groupPrintSetWeight( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
	...
	public void groupToggleDebug( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
	...
	public void groupPrefix( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupSuffix( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupCreate( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		PermissionGroup group = PermissionsEx.getPermissionManager().getGroup( args.get( "group" ) );
	...
	public void groupDelete( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
	...
	public void groupListParentsAlias( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
	...
	public void groupListParents( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupSetParents( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupAddParents( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupRemoveParents( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupListAliasPermissions( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
	...
	public void groupListPermissions( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupAddPermission( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupSetOption( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupRemovePermission( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void userSwapPermission( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupAddTimedPermission( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupRemoveTimedPermission( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupUsersList( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
	...
	public void groupUsersAdd( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupUsersRemove( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupDefaultCheck( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
	...
	public void groupDefaultSet( Plugin plugin, SentientHandler sender, Map<String, String> args )
	{
		String groupName = this.autoCompleteGroupName( args.get( "group" ) );
		String siteName = this.autoCompleteSiteName( args.get( "site" ) );
